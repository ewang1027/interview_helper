...
SURFACE = {
    ...
    ("GET", "/api/v1/corpus/items/{item_id}"),
    ("GET", "/api/v1/concepts"),
    ("GET", "/api/v1/costs"),
    ...
    ("POST", "/api/v1/jobs/recompute"),
    ("GET", "/api/v1/jobs/{application_id}"),
    ("DELETE", "/api/v1/jobs/{application_id}"),
    ("POST", "/api/v1/jobs/{application_id}/stage"),
    ("PATCH", "/api/v1/jobs/{application_id}/classification"),
    ("GET", "/api/v1/plan/next"),
    ("POST", "/api/v1/practice/problems"),
